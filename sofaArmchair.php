...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="5">
    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/sofa/Ghe-Armchair1.png">
        <img src="img/sofa/Ghe-Armchair2.png">
        <img src="img/sofa/Ghe-Armchair3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/sofa/Ghe-Armchair.png">
      </div>
    </div>

    <!-- RIGHT -->
    <div class="product-info">
      <h1 id="product-name">Ghế sofa Armchair</h1>

      <div class="price">
        <span class="new-price">1.790.000đ</span>
        <span class="old-price">2.000.000đ</span>
  <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">1790000</span>
</div>      
      <div class="description">

    <p><strong>Phong cách:</strong> Mid-century Modern - Tối giản</p>
    <p><strong>Màu sắc:</strong> Khung gỗ óc chó + Vải xanh olive</p>
    <p><strong>Chất liệu:</strong> Khung gỗ tự nhiên + Nệm vải dệt cao cấp</p>
    <p><strong>Thiết kế nổi bật:</strong> Tay vịn rộng, lưng cao, dáng ngồi thoải mái</p>
...
<div id="description" class="tab-body active">
        <h2>Sự Kết Hợp Hoàn Hảo Giữa Thẩm Mỹ Và Thoải Mái</h2>
            
            <p>
                Ghế Armchair VLINE là hiện thân của phong cách Mid-century Modern tinh tế. 
                Với khung gỗ óc chó tự nhiên ấm áp kết hợp cùng lớp vải dệt màu xanh olive sang trọng, ghế không chỉ là nơi ngồi mà còn là một tác phẩm nội thất đầy nghệ thuật.
            </p>

            <p>
                Thiết kế tay vịn rộng, lưng tựa cao và góc ngồi vừa vặn mang đến cảm giác ôm ấp và thư giãn tối đa. 
                Chân ghế dạng vát mạnh mẽ tạo nên sự cân đối và vững chãi, giúp ghế dễ dàng hòa quyện vào nhiều không gian sống hiện đại.
            </p>

        <div class="product-info">
            <div>
                <strong>Khung:</strong> Rộng 68cm x Sâu 75cm x Cao 92cm
            </div>
            <div>
                <strong>Phong cách:</strong> Mid-century Modern
            <div>
               <strong>Màu sắc:</strong> Khung gỗ óc chó + Vải xanh olive
            </div>
            <div>
                <strong>Chất liệu:</strong> Khung gỗ tự nhiên cao cấp + Vải dệt bouclé cao cấp
                </div>
                <div>
                <strong>Đặc điểm nổi bật:</strong> Tay vịn rộng thoải mái, lưng cao tựa đầu, dáng ngồi êm ái, thiết kế chân vát hiện đại
                </div>
            <div>
...
<script>
fetch("getSanPham.php?custom_order=9,10,11,12,13,14,15,16")
  .then(res => res.json())
  .then(data => {
