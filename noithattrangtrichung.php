...
<section class="new-products">
  ...
  <div class="section-header">
    <h2>NỘI THẤT TRANG TRÍ CHUNG</h2>
    <div class="line"></div>
  </div>
...
function loadphonganProducts() {
  fetch("getSanPham.php?custom_order=17,19,65,72,29,30,25,26,133,67,68,69,73,59,60,64")
    .then(res => res.json())
    .then(data => {
      let html = "";
       ...
       data.forEach(sp => {
        ...
        // 
        if (sp.id == 17) {
          linkStart = `<a href="dentrangtri.php" class="product-card">`;
          linkEnd = `</a>`;
        } 
        else if (sp.id == 133) {
