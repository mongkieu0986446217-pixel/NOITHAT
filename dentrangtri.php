...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="17">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Den/Den-1.png">
        <img src="img/Den/Den-2.png">
        <img src="img/Den/Den-3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Den/Den-TT.png">
      </div>
    </div>
...
<h1 id="product-name">Đèn trang trí</h1>

      <div class="price">
        <span class="new-price">699.000đ</span>
        <span class="old-price">1.000.000đ</span>
 <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">699000</span>
</div>

      <div class="description">
    <p><strong>Phong cách:</strong> Hiện đại - Sang trọng tinh tế</p>
    <p><strong>Màu sắc:</strong> Men ngọc xanh pastel + Vàng ánh kim</p>
    <p><strong>Chất liệu:</strong> Thân đèn gốm sứ cao cấp, chụp đèn vải xếp ly</p>
    <p><strong>Đặc điểm nổi bật:</strong> Thiết kế giọt nước mềm mại, ánh sáng ấm áp dịu nhẹ</p>
    <p class="note">
...
<!-- MÔ TẢ -->
    <div id="description" class="tab-body active">
        <h2>Điểm Nhấn Nghệ Thuật Cho Không Gian Sống</h2>
            
            <p>
                Đèn bàn TT Ngọc Xanh là sự giao thoa tinh tế giữa truyền thống gốm sứ và thiết kế hiện đại. 
                Thân đèn được chế tác từ gốm sứ men ngọc xanh pastel mềm mại, kết hợp cùng chi tiết vàng ánh kim sang trọng, tạo nên vẻ đẹp vừa thanh lịch vừa ấm áp.
            </p>

            <p>
                Chao đèn vải xếp ly hình bán cầu với viền scalloped (hình sóng nhẹ) giúp ánh sáng lan tỏa dịu dàng, không chói, mang lại không khí thư giãn lý tưởng cho phòng ngủ, phòng khách hoặc góc làm việc.
            </p>

        <div class="product-info">
            <div>
                <strong>Kích thước:</strong> Cao khoảng 45-50cm (tùy model)
            </div>
            <div>
                <strong>Phong cách:</strong> Hiện đại - Nghệ thuật tinh tế
            </div>
            <div>
                <strong>Màu sắc:</strong> Men ngọc xanh pastel + Vàng gold
            </div>
            <div>
                <strong>Chất liệu:</strong> Thân gốm sứ cao cấp, chụp đèn vải cao cấp xếp ly
                </div>
            <div>
            <strong>Đặc điểm nổi bật:</strong> Thiết kế giọt nước mềm mại, ánh sáng ấm vàng, dễ phối với nhiều phong cách nội thất
                </div>
                <div>
...
<script>
fetch("getSanPham.php?custom_order=31,32,29,30,22,23,25,26")
  .then(res => res.json())
  .then(data => {
