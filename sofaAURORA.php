...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="1">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/sofa/Ghe-sofa-AURORA1.png">
        <img src="img/sofa/Ghe-sofa-AURORA2.png">
        <img src="img/sofa/Ghe-sofa-AURORA3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/sofa/Ghe-sofa-AURORA.png">
      </div>
    </div>

    <!-- RIGHT -->
    <div class="product-info">
      <h1 id="product-name">Ghế sofa AURORA</h1>

    <div class="price">
    <span class="new-price">23.000.000đ</span>
    <span class="old-price">25.000.000đ</span>

  <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">23000000</span>
</div>

      <div class="description">

      <p><strong>Kích thước bàn:</strong> D250x S109x C77 cm</p>
      <p><strong>Phong cách:</strong> Contemporary Italian - thanh lịch, hiện đại </p>
      <p><strong>Chất liệu:</strong></p>
      <p>Foam: 30kgs/m3 HA pur foam ( HA30) + 25kgs/m3 SO pur foam ( SO25) + Fiber</p>
      <p>Vải: 100% polyester</p>
      <p>Chân inox đánh bóng</p>
      <p>Khung gỗ tự nhiên</p>
      
      <p><strong>Chứng nhận:</strong></p>
      <p><strong>SGS Certified -</strong>An toàn cho người dùng</p>
      <p><strong>BS 5852 -</strong> Vải chống cháy</p>
      <p><strong>ISO 105 -B02 -</strong> Bền màu với ánh sáng: 5/5</p>
      <p><strong>ISO 105 - X12 -</strong> Bền màu khi ma sát: 4/5 (khô & ướt)</p>
      <p><strong>Gối đi kèm:</strong> 8 gối rời, bao gồm gối tựa lưng và gối trang trí </p>
      <p><strong>Màu sắc:</strong> Trắng xám phối đen - hiện đại, tinh tế và dễ kết hợp </p>
      <p class="note">
...
<!-- MÔ TẢ -->
 <div id="description" class="tab-body active">
        ...
        <div class="product-info">
            <div>
                <strong>Khung:</strong> Gỗ tự nhiên, chống công vênh
            </div>
            <div>
                <strong>Vải bọc:</strong> Vải xám cao cấp, thoáng khí, chống nhăn
            </div>
            <div>
                <strong>Chân:</strong> Inox 201 đánh bóng
            </div>
            <div>
                <strong>Gối đi kèm:</strong> 8 gối vải + da phối màu
            </div>
            <div>
...
<script>
    ...
    function updateCartCount() {
        let cart = JSON.parse(localStorage.getItem("cart_" + currentUserId)) || [];
        let total = cart.reduce((sum, item) => sum + (parseInt(item.quantity) || 0), 0);
    ...
    // ================== KHỞI TẠO & CẬP NHẬT TỰ ĐỘNG ==================
    document.addEventListener("DOMContentLoaded", function() {
        updateCartCount();
    });

    // Cập nhật lại số lượng mỗi khi quay lại trang (rất quan trọng)
    window.addEventListener("focus", updateCartCount);

    // Cập nhật khi chuyển tab trở lại
...
<script>
fetch("getSanPham.php?custom_order=9,10,11,12,13,8,7,6")
  .then(res => res.json())
  .then(data => {
