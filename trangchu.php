  ...
  <!-- LOGIN -->
    ...
    <!-- ===== ĐĂNG NHẬP ===== -->
      <div class="card hidden" id="loginForm">
        ...
        <p class="subtitle">Nhập email và mật khẩu của bạn</p>
        ...
        <p class="link">
          Quên mật khẩu?
          <span onclick="showRecover()">Khôi phục mật khẩu</span>
        </p>
      </div>


      <!-- ===== KHÔI PHỤC ===== -->
      <div class="card hidden" id="recoverForm">
        <h2>KHÔI PHỤC MẬT KHẨU</h2>

        
        <input id="emailInput" type="email" placeholder="Email">
        <input id="phoneInput" class="hidden" type="text" placeholder="Số điện thoại">

        <button id="recoverBtn">KHÔI PHỤC</button>
        <button id="sendCodeBtn" class="hidden">GỬI MÃ XÁC NHẬN</button>

        <p class="link">
          Bạn đã nhớ mật khẩu?
          <span onclick="showLogin()">Trở về đăng nhập</span>
        </p>
      </div>
...
<section class="banner">
  ...
  <div class="slider">
    <img src="img/banner1.png"class="slide active">
    <img src="img/banner2.png" class="slide">
    <img src="img/banner3.png" class="slide">
  </div>
...
<div class="new-product-grid" id="homeProductList">
 ...
 <a href="/WNT/sofaAURORA.php" class="product-card">
  <img src="img/sofa/Ghe-sofa-AURORA.png" alt="">
  <h3>Ghế sofa AURORA</h3>
  <p class="price">13.999.000đ</p>
</a>

 <a href="tugiay.php" class="product-card">
      <img src="img/TvK/Tu-giay.png" alt="">
      <h3>Tủ giày</h3>
...
<section class="suggest">
  ...
  <h2 class="suggest-title">GỢI Ý</h2>
  <div class="suggest-line"></div>

  <div class="suggest-product-grid" id="suggestProductList">

    <a href="/WNT/giuongngugotram1.php" class="product-card">
      <img src="img/Giuong/Giuong-go-tram.png" alt="">
      <h3>Giường ngủ gỗ tràm</h3>
      <p class="price">13.000.000đ</p>
    </a>

    <a href="WNT/banango.php" class="product-card">
      <img src="img/Ghe-Ban/Ban-an-go.png" alt="">
      <h3>Bàn ăn gỗ</h3>
...
<section class="main-products">
  ...
  <div class="main-product-grid">
    <a href="noithatphongkhach.php" class="product-item">
      <img src="img/noithatphongkhach.png">
      <div class="product-title">ĐỒ NỘI THẤT PHÒNG KHÁCH</div>
    </a>

    <a href="noithatphongan.php" class="product-item">
      <img src="img/noithatphongan.png">
      <div class="product-title">ĐỒ NỘI THẤT PHÒNG ĂN</div>
    </a>

    <a href="noithatphongngu.php" class="product-item">
      <img src="img/noithatphongngu.png">
      <div class="product-title">ĐỒ NỘI THẤT PHÒNG NGỦ</div>
    </a>

    <a href="noithattrangtrichung.php" class="product-item">
      <img src="img/noithattongthe.png">
      <div class="product-title">ĐỒ NỘI THẤT TRANG TRÍ CHUNG</div>
    </a>
  </div>
</section>
...
.then(data => {
  ...
  if (data.status === "success") {
    ...
    message.innerText = "Email không tồn tại!";
  }
})
.catch(() => {
...
function loadHomeProducts() {
  fetch("getSanPham.php?custom_order=1,2,31,60,57,64,68,129")
    .then(res => res.json())
    .then(data => {
      let html = "";
      ...
      data.forEach(sp => {
        ...
        // 👉 chỉ 2 sản phẩm có link
        if (sp.id == 1) {
          linkStart = `<a href="sofaAURORA.php" class="product-card">`;
          linkEnd = `</a>`;
        } 
        else if (sp.id == 57) {
          linkStart = `<a href="tugiay.php" class="product-card">`;
          linkEnd = `</a>`;
        }

        html += `
          ${linkStart}
            <img src="${sp.anh_san_pham}">
      ...
      // 
      document.getElementById("homeProductList").innerHTML = html;
    });
}
...
function loadSuggestProducts() {
  fetch("getSanPham.php?custom_order=33,25,56,67,121,122,134,135")
    .then(res => res.json())
    .then(data => {
      let html = "";
      ...
      data.forEach(sp => {
        ...
        if (sp.id == 33) {
          ...
          linkStart = `<a href="banango.php" class="product-card">`;
          linkEnd = `</a>`;
        }
      ...
      // 👉 QUAN TRỌNG: dòng này KHÔNG ĐƯỢC THIẾU
      document.getElementById("suggestProductList").innerHTML = html;
    });
}
</script>
