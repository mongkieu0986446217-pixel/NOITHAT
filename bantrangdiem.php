...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="133">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Ghe-Ban/Ban-trang-diem1.png">
        <img src="img/Ghe-Ban/Ban-trang-diem2.png">
        <img src="img/Ghe-Ban/Ban-trang-diem3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Ghe-Ban/Ban-trang-diem.png">
      </div>
    </div>
...
<h1 id="product-name">Bàn trang điểm</h1>

      <div class="price">
        <span class="new-price">3.510.000đ</span>
        <span class="old-price">3.810.000đ</span>
       <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">3510000</span>
</div>

      <div class="description">
    <p><strong>Phong cách:</strong> Tối giản hiện đại - Mid-century</p>
    <p><strong>Màu sắc:</strong> Gỗ óc chó tự nhiên</p>
    <p><strong>Chất liệu:</strong> Gỗ công nghiệp cao cấp, chân gỗ tự nhiên</p>
    <p><strong>Thiết kế nổi bật:</strong> 2 hộc tủ + 1 ngăn kéo giữa + gương lớn</p>
    <p class="note">
...
<div id="description" class="tab-body active">  
    <h2>Điểm Nhấn Tinh Tế Cho Không Gian Phòng Ngủ</h2>
            
            <p>
                Bàn trang điểm VLINE là sự kết hợp hoàn hảo giữa thiết kế tối giản hiện đại và vẻ đẹp ấm áp của gỗ óc chó. 
                Với hình dáng thanh lịch, chân bàn dạng vát đặc trưng phong cách Mid-century, sản phẩm không chỉ là nơi trang điểm mà còn là món đồ nội thất trang trí đầy nghệ thuật.
            </p>

            <p>
                Bàn được thiết kế thông minh với 2 hộc tủ bên + 1 ngăn kéo giữa rộng rãi, mặt bàn phẳng giúp bạn dễ dàng sắp xếp mỹ phẩm, trang sức và phụ kiện. 
                Gương lớn vuông vức mang lại cảm giác rộng rãi và tiện lợi khi sử dụng.
            </p>

        <div class="product-info">
            <div>
                <strong>Kích thước:</strong> Rộng 120cm x Sâu 45cm x Cao 75cm
            </div>
            <div>
                <strong>Phong cách:</strong> Mid-century Modern - Tối giản
            </div>
            <div>
                <strong>Màu sắc:</strong> Gỗ óc chó tự nhiên
            </div>
            <div>
                <strong>Chất liệu:</strong> Gỗ công nghiệp cao cấp + Chân gỗ tự nhiên
                </div>
                <div>
                <strong>Đặc điểm nổi bật:</strong> 2 hộc tủ + 1 ngăn kéo giữa, mặt bàn rộng, gương lớn, chân vát hiện đại
                </div>
            <div>
...
<script>
fetch("getSanPham.php?custom_order=61,62,58,54,77,137,139,75")
  .then(res => res.json())
  .then(data => {
