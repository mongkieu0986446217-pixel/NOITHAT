...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="125">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Ghe-Ban/Ghe-an-go1.png">
        <img src="img/Ghe-Ban/Ghe-an-go2.png">
        <img src="img/Ghe-Ban/Ghe-an-go3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Ghe-Ban/Ghe-an-go.png">
      </div>
    </div>
    ...
    <div class="product-info">
      ...
      <h1 id="product-name">Ghế ăn gỗ cao su tự nhiên SERENA</h1>

      <div class="price">
        <span class="new-price">1.000.000đ</span>
        <span class="old-price">1.399.000đ</span>
 <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">1000000</span>
</div>
      <div class="description">

      <p><strong>Kích thước: </strong> 460 x 520 x 820 (mm)</p>
      <p><strong>Chất liệu khung/chân:</strong> Gỗ cao su tự nhiên</p>
      <p><strong>Chất liệu tựa lưng:</strong>Gỗ Plywood chuẩn CARB-P2 (*)</p>
      <p><strong>Chất liệu đệm ngồi:</strong>Mousse bọc vải (Fabric) cao cấp, chống bám bụi, trượt nước</p>
      <p class="note">
...
<section class="product-tabs">
    ...
    <div id="description" class="tab-body active">
        <h2>Ghế ăn gỗ cao su tự nhiên SERENA </h2>

        <p>
          Ghế Ăn SERENA 
          Đơn Giản Tinh Tế, Êm Ái Cả Khi Ngồi Lâu
        </p>
        ...
        <div>
          ...
          <p>Ghế ăn SERENA không chỉ là một món nội thất, mà còn là dấu ấn của lối sống tinh tế...</p>
        </div>

        <div>
          <p><strong>*Nguồn cảm hứng thiết kế:</strong> Lấy cảm hứng từ phong cách Bắc Âu...</p>
          <p><strong>*Trải nghiệm ngồi:</strong> Tựa lưng cong ôm sát...</p>
          <p><strong>*Vật liệu:</strong> Nệm bọc vải cao cấp...</p>
        </div>

        <div>
          <p><strong>*Khung & chân ghế:</strong> Gỗ cao su tự nhiên...</p>
          <p><strong>*Tựa lưng:</strong> Gỗ Plywood chuẩn CARB-P2...</p>
        </div>

        <div>
          <strong>Màu sắc & phối hợp:</strong>
          <p>Khung ghế nâu trầm hoặc gỗ sáng tự nhiên...</p>
        </div>

        <div><strong>Chất liệu khung/chân:</strong> Gỗ cao su tự nhiên</div>
        <div><strong>Chất liệu tựa lưng:</strong> Gỗ Plywood</div>
        <div><strong>Chất liệu đệm:</strong> Mousse bọc vải</div>
        <div><strong>Phong cách:</strong> Scandinavian + Italian</div>
...
<script>
fetch("getSanPham.php?custom_order=126,127,128,134,135,131,132,133")
  .then(res => res.json())
  .then(data => {
