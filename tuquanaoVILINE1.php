...
<div class="product-container" id="product" data-id="53">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/TvK/Tu-quan-ao-VLINE-2-canh .png ">
        <img src="img/TvK/Tu-quan-ao-VLINE-2-canh-goc.png">
        <img src="img/TvK/Tu-quan-ao-VLINE-4-canh.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/TvK/Tu-quan-ao-VLINE.png">
      </div>
    </div>
    ...
    <div class="product-info">
      ...
      <h1 id="product-name">Tủ quần áo VLINE</h1>

      <div class="price">
        <span class="new-price">9.699.000đ</span>
        <span class="old-price">10.000.000đ</span>
<!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">9699000</span>
</div> 
      <div class="description">

      <p><strong>Phong cách:</strong> Tối giản hiện đại - Sang trọng</p>
      <p><strong>Màu sắc:</strong> Gỗ óc chó tự nhiên</p>
      <p><strong>Chất liệu:</strong> Gỗ công nghiệp cao cấp kết hợp mây tự nhiên</p>
      <p><strong>Thiết kế nổi bật:</strong> 4 cánh cửa mây + 2 hộc kéo, cửa mây thoáng khí</p>
      <p class="note">
...
<div id="description" class="tab-body active">
        <h2>Định Nghĩa Mới Của Sự Tinh Tế & Thoáng Khí</h2>
            
            <p>
                Tủ quần áo VLINE là sự kết hợp hoàn hảo giữa vẻ đẹp tối giản hiện đại và chất liệu mây tự nhiên. 
                Với thiết kế 4 cánh cửa mây thoáng khí, tủ không chỉ giúp lưu trữ quần áo mà còn tạo điểm nhấn thẩm mỹ tinh tế cho không gian phòng ngủ.
            </p>

            <p>
                Gam màu gỗ óc chó ấm áp kết hợp với lớp mây đan tay thủ công mang lại cảm giác gần gũi với thiên nhiên, 
                đồng thời giúp không khí lưu thông tốt, hạn chế ẩm mốc - rất phù hợp với khí hậu Việt Nam.
            </p>

<div class="product-info">
            <div>
                <strong>Phong cách:</strong> Japandi - Tối giản hiện đại
            </div>
            <div>
                <strong>Màu sắc:</strong> Gỗ óc chó tự nhiên
            </div>
            <div>
                <strong>Chất liệu:</strong> Gỗ công nghiệp cao cấp + Mây tự nhiên đan tay
                </div>
            <div>
                <strong>Kích thước:</strong> Rộng 240cm x Cao 220cm x Sâu 60cm (4 cánh + 2 hộc kéo)
                </div>
                <div>
                <strong>Đặc điểm nổi bật:</strong> Cửa mây thoáng khí, hộc kéo tiện lợi, thiết kế liền khối sang trọng
                </div>
            <div>
...
<script>
fetch("getSanPham.php?custom_order=139,54,76,75,58,61,62,74")
  .then(res => res.json())
  .then(data => {
