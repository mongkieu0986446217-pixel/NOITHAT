...
<div class="new-product-grid" id="livingRoomList">
   ...
   <a href ="WNT/dentrangtri.php" class="product-card">
      <img src="img/Den/Den-TT.png" alt="">
      <h3>Đèn trang trí</h3>
...
<script>
function loadphongkhachProducts() {
  fetch("getSanPham.php?custom_order=21,22,129,64,57,3,8,30,130,32,60,6,61,25,62,31")
    .then(res => res.json())
    .then(data => {
      let html = "";
      ...
      data.forEach(sp => {
        ...
        // 
        if (sp.id == 21) {
          linkStart = `<a href="denchum.php" class="product-card">`;
          linkEnd = `</a>`;
        } 
        else if (sp.id == 57) {
