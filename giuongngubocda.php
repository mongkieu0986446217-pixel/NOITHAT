...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="34">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Giuong/Giuong-ngu-boc-da1.png">
        <img src="img/Giuong/Giuong-ngu-boc-da2.png">
        <img src="img/Giuong/Giuong-ngu-boc-da3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Giuong/Giuong-ngu-boc-da.png">
      </div>
    </div>
...
<h1 id="product-name">Giường ngủ bọc da</h1>

      <div class="price">
        <span class="new-price">17.500.000đ</span>
        <span class="old-price">17.999.000đ</span>
 <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">17500000</span>
</div>
      <div class="description">

      
    <p><strong>Phong cách:</strong> Hiện đại tối giản - Sang trọng</p>
    <p><strong>Màu sắc:</strong> Be nhạt / Kem cao cấp</p>
    <p><strong>Chất liệu:</strong> Da PU cao cấp + Khung gỗ tự nhiên</p>
    <p><strong>Thiết kế nổi bật:</strong> Đầu giường cao bọc da, đường may tinh tế, thiết kế liền khối</p>
    <p class="note">
...
<div id="description" class="tab-body active">
        <h2>Không Gian Nghỉ Ngơi Đẳng Cấp Và Tinh Tế</h2>
            
            <p>
                Giường ngủ bọc da VLINE là biểu tượng của sự sang trọng tối giản trong phòng ngủ hiện đại. 
                Với đầu giường cao bọc da PU cao cấp màu be nhạt tinh tế, đường may thẳng hàng sắc sảo, giường mang đến vẻ đẹp liền mạch và thanh lịch.
            </p>

            <p>
                Thiết kế khung gỗ tự nhiên chắc chắn kết hợp cùng lớp da mềm mại tạo cảm giác êm ái và thoải mái tối đa. 
                Gam màu trung tính dễ dàng phối hợp với nhiều phong cách nội thất, từ tối giản đến hiện đại cao cấp, giúp không gian phòng ngủ trở nên rộng rãi và ấm áp hơn.
            </p>

        <div class="product-info">
            <div>
                <strong>Kích thước:</strong> 180x200cm (King size) - Có thể đặt theo kích thước khác
                </div>
            <div>
                <strong>Phong cách:</strong> Hiện đại tối giản - Sang trọng
            </div>
            <div>
                <strong>Màu sắc:</strong> Be nhạt / Kem cao cấp
            </div>
            <div>
                <strong>Chất liệu:</strong> Da PU cao cấp + Khung gỗ tự nhiên chắc chắn
                </div>
            <div>
               <strong>Đặc điểm nổi bật:</strong> Đầu giường cao bọc da, đường may tinh tế, thiết kế liền khối hiện đại, dễ vệ sinh
                </div>
                        <div>
    ...
    <div id="reviews" class="tab-body">
        ...
        <div class="review-item">
            ...
            <p>Sản phẩm đẹp, chắc chắn, giao hàng nhanh.</p>
        </div>
        ...
        <div class="review-item">
            ...
            <p>Đúng mô tả, lắp ráp dễ dàng, sẽ ủng hộ lần sau.</p>
        </div>
...
<script>
fetch("getSanPham.php?custom_order=40,41,42,43,44,4,546,47,48")
  .then(res => res.json())
  .then(data => {
