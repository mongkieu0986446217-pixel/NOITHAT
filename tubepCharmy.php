...
<div class="product-container" id="product" data-id="137">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Ghe-Ban/Tu-bep1.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Ghe-Ban/Tu-bep.png">
      </div>
    </div>
    ...
    <div class="product-info">
      ...
      <h1 id="product-name">Tủ bếp Charmy</h1>
 

      <div class="price">
        <span class="new-price">13.000.000đ</span>
        <span class="old-price">13.980.000đ</span>
  <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">13000000</span>
</div> 
      <div class="description">

      <p><strong>Phong cách:</strong> Tối giản hiện đại - Sang trọng Ý</p>
    <p><strong>Màu sắc:</strong> Gỗ óc chó kết hợp kem nhạt</p>
    <p><strong>Mặt bếp:</strong> Đá nhân tạo cao cấp</p>
    <p><strong>Đặc điểm nổi bật:</strong> Kệ mở có đèn LED, thiết kế liền khối, tối ưu không gian</p>
    <p class="note">
...
<div id="description" class="tab-body active">
        <h2>Định Nghĩa Mới Của Nhà Bếp Sang Trọng Tối Giản</h2>

        <p>
            Tủ bếp Charmy là sự kết hợp hoàn hảo giữa thiết kế tối giản hiện đại và sự tinh tế sang trọng. 
            Gam màu gỗ óc chó ấm áp phối cùng tone kem nhạt tạo nên không gian bếp vừa gần gũi vừa đẳng cấp.
        </p>

        <div class="product-info">
            <div>
                <strong>Phong cách:</strong> Tối giản hiện đại
            </div>
            <div>
                <strong>Màu sắc:</strong> Gỗ óc chó kết hợp kem nhạt
            </div>
            <div>
                <strong>Chất liệu chính:</strong> Gỗ công nghiệp cao cấp chuẩn CARB-P2, mặt đá nhân tạo
                </div>
            <div>
                <strong>Đặc điểm nổi bật:</strong> Kệ mở đèn LED, đảo bếp tiện nghi, thiết kế chữ I + đảo
                </div>
            <div>
