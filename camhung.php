...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="camhung1.css">
</head>
<body>
...
<div class="insp-hero">
  ...
  <div class="hero-big">
    ...
    <div class="hero-text">
      ...
      <p>Thiết kế hiện đại - tối giản - tinh tế</p>
    </div>
  </div>
  ...
  <div class="hero-small">
    ...
    <div class="small-item">
      <img src="img/phong-ngu-toi-gian-dep.png" alt="">
      <div class="small-text">Phòng ngủ thư giãn</div>
    </div>

    <div class="small-item">
      <img src="img/khong-gian-song.png" alt="">
      <div class="small-text">Decor tối giản</div>
    </div>
...
<section class="inspiration">
  ...
  <div class="inspiration-grid">
    ...
    <a href ="camhungphongkhach.php"class="insp-item">
      <img src="img/sofa/Ghe-sofa-AURORA.png" alt="">
      <div class="insp-content">
        <h3>Phòng khách hiện đại</h3>
        <p>Không gian tinh tế, tối giản và sang trọng.</p>
      </div>
    </a>

    <a href ="camhungphongngu.php" class="insp-item">
      <img src="img/Giuong/Giuong-ngu-boc-da.png" alt="">
      <div class="insp-content">
        <h3>Phòng ngủ ấm cúng</h3>
        <p>Thiết kế nhẹ nhàng, thư giãn.</p>
      </div>
    </a>

    <div class="insp-item">
      <img src="img/camhung/khong-gian-song.png" alt="">
      <div class="insp-content">
        <h3>Không gian </h3>
        <p>Phong cách cổ điển pha hiện đại.</p>
      </div>
    </div>

    <div class="insp-item">
      <img src="img/camhung/camhungphongan.png" alt="">
      <div class="insp-content">
        <h3>Decor tối giản</h3>
        <p>Phòng ăn sang trọng</p>
      </div>
    </div>

    
    <div class="insp-item">
      <img src="img/camhung/bo-suu-tap-thu-dong.png" alt="">
      <div class="insp-content">
        <h3>Phòng khách hiện đại</h3>
        <p>Không gian tinh tế, tối giản và sang trọng.</p>
      </div>
    ...
    <div class="insp-item">
      <img src="img/camhung/bo-suu-tap-tham.png" alt="">
      <div class="insp-content">
        <h3>Phòng khách hiện đại</h3>
        <p>Không gian tinh tế, tối giản và sang trọng.</p>
      </div>
    ...
    <div class="insp-item">
      <img src="img/camhung/cau-chuyen-mau-sac.png" alt="">
      <div class="insp-content">
        <h3>Phòng khách hiện đại</h3>
        <p>Không gian tinh tế, tối giản và sang trọng.</p>
      </div>
