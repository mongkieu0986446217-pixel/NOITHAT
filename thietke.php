...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="thietkeF.css">
</head>
<body>
...
<section class="inspiration">
  ...
  <div class="insp-grid">
    ...
    <!-- ITEM -->
    <div class="insp-card">
      <img src="img/thiet-ke/Bia-Housef-3.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>CELESTA RISE</h3>
      <p>
        Hân hạnh là đối tác cung cấp sản phẩm đồ rời cho nhà hàng phân khúc trung và cao cấp...
      </p>
      <a href="#">Xem thêm ></a>
    </div>
    ...
    <!-- ITEM -->
    <div class="insp-card">
      <img src="img/thiet-ke/housef-mrthuan1-13.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>Căn hộ Shabby Chic - Ecopark</h3>
      <p>
        Không dừng lại trong hành trình tìm lại cảm hứng trong những giá trị xưa cũ...
      </p>
      <a href="#">Xem thêm ></a>
    </div>
    ...
    <!-- ITEM -->
    <div class="insp-card">
      <img src="img/thiet-ke/infinity-HF-4.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>Chi Tiết Thiết Kế Nội Thất
Phòng khách</h3>
      <p>
        Với sự lên ngôi của những đường cong mềm mại kết hợp cùng vật liệu cao cấp...
      </p>
      <a href="#">Xem thêm ></a>
    </div>

    <div class="insp-card">
      <img src="img/thiet-ke/thiet-ke-noi-that-can-ho.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>hiết Kế Căn Hộ Melbourne</h3>
      <p>
        Không gian phòng khách tinh tế với gam màu trung tính và nội thất hiện đại
      </p>
      <a href="#">Xem thêm ></a>
    </div>

    <div class="insp-card">
      <img src="img/thiet-ke/phong-khach-opal.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>Thiết Kế Thi Công Nội Thất Căn Hộ Opal Riverside</h3>
      <p>
        Từng không gian trong thiết kế thi công nội thất căn hộ
Phòng khách và bếp - Không gian liên thông hiện đại
      </p>
      <a href="#">Xem thêm ></a>
    </div>

    <div class="insp-card">
      <img src="img/thiet-ke/phongkhach.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>Thiết Kế Thi Công Nội Thất Căn Hộ Sunrise 1 Phòng Ngủ Wabi Sabi</h3>
      <p>
        Không theo đuổi sự bóng bẩy, không nhồi nhét chi tiết rườm rà, căn hộ được thổi hồn bởi phong cách Wabi-Sabi...
      </p>
      <a href="#">Xem thêm ></a>
    </div>

    <div class="insp-card">
      <img src="img/thiet-ke/Screenshot.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>Thiết kế căn hộ sang trọng </h3>
      <p>
        Phong cách thiết kế sang trọng (Luxury) là sự kết hợp hoàn hảo giữa vật liệu cao cấp, màu sắc tinh tế và đường nét thiết kế chỉn chu.
      </p>
      <a href="#">Xem thêm ></a>
    </div>

    <div class="insp-card">
      <img src="img/thiet-ke/Bia-Housef-1-4.png" alt="">
      <div class="insp-meta">
        
      </div>
      <h3>THE DRAYTON</h3>
      <p>
        Bản giao thoa của ánh sáng, vật liệu và nhịp sống hiện đại
      </p>
      <a href="#">Xem thêm ></a>
    </div>
