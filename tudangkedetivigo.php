...
<div class="product-container" id="product" data-id="61">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/TvK/Tu-ke-go-tivi1.png">
        <img src="img/TvK/Tu-ke-go-tivi2.png">
        <img src="img/TvK/Tu-ke-go-tivi3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/TvK/Tu-ke-go-tivi.png">
      </div>
    </div>
 ...
 <h1 id="product-name">Tủ dạng kệ để tivi gỗ</h1>
 

      <div class="price">
        <span class="new-price">2.200.000đ</span>
        <span class="old-price">3.000.000đ</span>
<!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">2200000</span>
</div>
      <div class="description">

      <p><strong>Kích thước kệ:</strong> Dài 160cm x Rộng 40cm x Cao 60cm</p>
      <p><strong>Ngăn chứa:</strong> 2 ngăn kéo + 2 hộc để đồ tiện lợi</p>
      <p><strong>Chất liệu:</strong></p>
      <p>Thân kệ: Gỗ MDF lõi xanh chống ẩm, phủ Melamine cao cấp</p>
      <p>Chân kệ: Gỗ tự nhiên chắc chắn</p>
      <p>Bề mặt: Chống trầy xước, dễ vệ sinh</p>
      <p class="note">
...
<div id="description" class="tab-body active">
        <h2>Tủ dạng kệ để tivi gỗ</h2>

        <p>
    Tủ kệ tivi thiết kế theo phong cách hiện đại, tối giản,
    phù hợp với phòng khách, căn hộ chung cư hoặc nhà phố.
    Sản phẩm giúp tối ưu không gian lưu trữ và tăng tính thẩm mỹ cho khu vực giải trí.
        </p>

        <div class="product-info">
    <div>
        <strong>Kích thước:</strong> 160 x 40 x 60 cm
    </div>
    <div>
        <strong>Chất liệu:</strong> Gỗ MDF lõi xanh chống ẩm
    </div>
    <div>
        <strong>Bề mặt:</strong> Phủ Melamine chống trầy
    </div>
    <div>
        <strong>Màu sắc:</strong> Nâu gỗ / Trắng / Vân gỗ
    </div>
    <div>
        <strong>Công năng:</strong> Để tivi, lưu trữ đồ, trang trí
    </div>
    <div>
