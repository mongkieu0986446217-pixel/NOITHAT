...
<div class="product-container" id="product" data-id="57">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/TvK/Tu-giay1.png">
        <img src="img/TvK/Tu-giay2.png">
        <img src="img/TvK/Tu-giay3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/TvK/Tu-giay.png">
      </div>
    </div>

    <!-- RIGHT -->
    <div class="product-info">
      <h1 id="product-name">Tủ giày</h1>
 

      <div class="price">
        <span class="new-price">3.650.000đ</span>
        <span class="old-price">4.000.000đ</span>
      <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">3650000</span>
</div> 

      <div class="description">

      <p><strong>Kích thước bàn:</strong> Dài 80cm x Rộng 36cm x Cao 92cm</p>
      <p><strong>Chất liệu:</strong></p>
      <p>Mặt tủ: Gỗ công nghiệp PB chuẩn CARB-P2 (*), Sơn phủ Melamine
      <p>Thân tủ: Gỗ công nghiệp MDF chuẩn CARB-P2 (*), Sơn phủ Melamine</p>
      <p>Chân tủ: Gỗ cao su tự nhiên</p>
      <p class="note">
...
<!-- MÔ TẢ -->
  <div id="description" class="tab-body active">
        ...
        <p>
            Tủ giày thiết kế theo phong cách tối giản hiện đại,
            phù hợp với không gian phòng ngủ, phòng làm việc hoặc căn hộ nhỏ.
        </p>

        <div class="product-info">
            <div>
                <strong>Kích thước:</strong> 120 x 60 x 75 cm
            </div>
            <div>
                <strong>Chất liệu:</strong>
                 <strong>Gỗ công nghiệp</strong> Sản phẩm sử dụng chất liệu gỗ công nghiệp (PB, MDF) đạt chuẩn CARB-P2 an toàn tuyệt đối cho người sức khỏe người dùng và đạt chứng nhận FSC bảo vệ và phát triển rừng.
               
            </div>
            <div>
                <strong>Gỗ cao su tự nhiên</strong> Gỗ cao su là chất liệu được sử dụng trong việc thiết kế nội thất giúp làm tăng khả năng chịu lực tốt và độ bền nhất định.
            </div>
            <div>
                <strong>Đặc điểm nổi bật:</strong> 
            </div>
            <div>
                <strong>Tối ưu khả năng lưu trữ của tủ giày</strong>  Tủ đựng giày sở hữ 4 ngăn kệ giúp tủ giày có thể chứa đựng từ 15 đến 20 đôi giày, dép đa dạng kích cỡ cho cả gia đình.
            </div>
             <div>
