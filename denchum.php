...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="21">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Den/Den-chum1.png">
        <img src="img/Den/Den-chum2.png">
        <img src="img/Den/Den-chum3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Den/Den-chum.png">
      </div>
    </div>
...
<h1 id="product-name">Đèn chùm</h1>

      <div class="price">
        <span class="new-price">3.000.000đ</span>
        <span class="old-price">3.999.000đ</span>
 <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">3000000</span>
</div>
      <div class="description">

      <p><strong>Kích thước đèn:</strong> Đường kính 60cm x Cao 80cm</p>
      <p><strong>Chất liệu:</strong> Hợp kim cao cấp, pha lê</p>
      <p><strong>Loại bóng:</strong> LED tiết kiệm điện</p>
      <p><strong>Ánh sáng:</strong> Trắng / vàng / trung tính</p>
      <p><strong>Điện áp:</strong> 220V</p>
...
<section class="product-tabs">
    ...
    <p>
        Đèn chùm thiết kế theo phong cách hiện đại, sang trọng,
        phù hợp với không gian phòng khách, phòng ăn hoặc sảnh lớn.
        Sản phẩm không chỉ cung cấp ánh sáng mà còn là điểm nhấn trang trí nổi bật cho ngôi nhà.
    </p>

    <div class="product-info">
        <div>
            <strong>Kích thước:</strong> Đường kính 60cm x Cao 80cm
        </div>
        <div>
            <strong>Chất liệu:</strong> Hợp kim cao cấp kết hợp pha lê / thủy tinh
        </div>
        <div>
            <strong>Loại bóng:</strong> LED tiết kiệm điện
        </div>
        <div>
            <strong>Ánh sáng:</strong> Trắng / vàng / trung tính
        </div>
        <div>
...
<script>
fetch("getSanPham.php?custom_order=18,19,20,22,23,24,25,26")
  .then(res => res.json())
  .then(data => {
