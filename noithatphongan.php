...
<section class="new-products">
 ...
 <a href ="WNT/gheangoSERENA.php"class="product-card">
      <img src="img/Ghe-Ban/Ghe-an-go.png" alt="">
      <h3>Ghế ăn gỗ cao su tự nhiên SERENA</h3>
...
<script>
function loadphonganProducts() {
  fetch("getSanPham.php?custom_order=121,122,123,124,125,126,51,52,137,139,132,128,55,131,56,127")
    .then(res => res.json())
    .then(data => {
      let html = "";
       ...
       data.forEach(sp => {
        ...
        if (sp.id == 121) {
          ...
          linkStart = `<a href="gheangoSERENA.php" class="product-card">`;
          linkEnd = `</a>`;
        }
        else if (sp.id == 137) {
