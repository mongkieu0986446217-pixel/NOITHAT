...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="camhungphongkhach.css">
</head>
<body>
...
<section class="banner">
  <img src="img/sofa/Ghe-sofa-AURORA.png" alt="Ảnh bìa">
...
<p>
Phòng khách là nơi thể hiện rõ nhất phong cách sống của bạn. Hãy tưởng tượng một không gian được bài trí tinh tế với chiếc sofa êm ái, ánh sáng dịu nhẹ và những chi tiết trang trí hài hòa. Tất cả tạo nên một góc thư giãn lý tưởng, nơi bạn có thể tận hưởng sự thoải mái và kết nối cùng gia đình mỗi ngày.
</p>  
...
<div class="about-section">
  <div class="about-container">
    ...
    <div class="about-image">
      <img src="img/sofa/Ghe-sofa-AURORA1.png" alt="Phòng khách">
    </div>

    <!-- Chữ bên phải -->
    <div class="about-text">
      <h2>Không gian phòng khách hiện đại</h2>
      <p>
        Phòng khách là nơi thể hiện rõ nhất phong cách sống của bạn. Hãy tưởng tượng một không gian được bài trí tinh tế với chiếc sofa êm ái, ánh sáng dịu nhẹ và những chi tiết trang trí hài hòa. Tất cả tạo nên một góc thư giãn lý tưởng.
      </p>
    </div>
...
<div class="sofa-section">
  <div class="sofa-container">
    ...
    <div class="sofa-image">
      <img src="img/sofa/Ghe-sofa-AURORA4.png" alt="Chi tiết sofa">
    </div>

    <!-- Chữ bên phải -->
    <div class="sofa-content">
      <h2>Thiết kế đệm ngồi êm ái & tinh tế</h2>
      <p>
        Phần đệm ngồi của sofa được thiết kế dày dặn với bề mặt vải dệt cao cấp, mang lại cảm giác êm ái và thoải mái khi sử dụng. Các đường may được hoàn thiện tỉ mỉ, tạo nên tổng thể gọn gàng và hiện đại.
      </p>
    </div>
...
<div class="inspiration-section">
  ...
  <div class="inspiration-grid">
    ...
    <!-- Card 4 - Phòng ngủ -->
<a href="camhungphongngu.php" class="product-card">
  <div class="image-wrapper">
    <img src="img/Giuong/Giuong-ngu-VLINE.png" alt="Phòng ngủ">
  </div>
  <div class="card-content">
    <h3>Không gian phòng ngủ thư giãn & tinh tế</h3>
    <p>Tận hưởng giấc ngủ trọn vẹn trong không gian yên bình, nơi thiết kế nhẹ nhàng và cảm xúc được nâng niu.</p>
  </div>
</a>
