...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="Camhungphongngu.css">
</head>
<body>
...
<section class="banner">
  <img src="img/Giuong/Giuong-ngu-VLINE.png" alt="Ảnh bìa">

  <div class="banner-dots">
    <!-- Nếu có dots thì để ở đây -->
  </div>
</section>

<!-- ================= MÔ TẢ ================= -->
<div class="description-section">
  <h1>PHÒNG NGỦ MÂY - VẺ ĐẸP BỀN VỮNG TỪ CHẤT LIỆU THÂN QUEN</h1>
  
  <p>Một trong những niềm tự hào của <strong>Nhà Lem</strong> chính là bộ sưu tập Mây, với những thiết kế mang vẻ đẹp thuần Việt thanh lịch. Mà giường ngủ Mây chính là minh chứng rõ ràng nhất cho gu thẩm mỹ tinh tế hiện đại mà Nhà Lem muốn mang đến cho từng tổ ấm.</p>
  
  <p>Từ lâu nay, chất liệu mây tre đan đã là một phần quen thuộc gắn với những làng quê Việt. Nhằm tôn vinh nét đẹp thuần Việt, <strong>Nhà Lem</strong> đã thiết kế nên chiếc giường ngủ Mây mang đến cảm giác gần gũi mà thanh lịch, hiện đại. Sự hòa quyện những gam màu đặc biệt: sắc màu nâu đỏ sang trọng, màu da kem thời thượng cùng tone vàng tự nhiên từ những sợi mây đan mang đến cảm giác dịu nhẹ hơn bao giờ hết.</p>
</div>   

<!-- ================= LAYOUT 2 ẢNH + CHỮ Ở GIỮA ================= -->
<section class="inspiration-layout">
  <div class="layout-container">

    <!-- Ảnh trái -->
    <div class="layout-image left">
      <img src="img/TvK/Tu-dau-giuong-go.png" alt="Phòng ngủ trái">
    </div>

    <!-- Phần chữ ở giữa -->
    <div class="layout-content">
            
      <p>Trên <strong>bàn đầu giường</strong> có thể đặt thêm chiếc <strong>bình trang trí</strong> được cắm vài <strong>nến thơm</strong> giúp cho không gian thêm mềm mại. Ngoài ra, bức tranh gắn phía trên đầu giường với nhiều chủ đề sẽ tiếp thêm năng lượng cho phòng ngủ, đưa gia chủ vào giấc ngủ ngon.</p>
      <p>Giường Mây khi kết hợp cùng những sản phẩm khác trong bộ sưu tập sẽ tạo nên một bản hòa thanh, nổi bật từ đường nét cho đến chất liệu, được trau chuốt từng chi tiết nhỏ. Để có thể thưởng thức vẻ đẹp của Mây, không gì tuyệt vời hơn việc ghé thăm trải nghiệm ngay tại các cửa hàng <strong>Nhà Lem</strong>.</p>
    </div>

    <!-- Ảnh phải -->
    <div class="layout-image right">
      <img src="img/Den/Den-ban.png" alt="Phòng ngủ phải">   
    </div>
...
<div class="description-section">
  <p>Hãy cùng khám phá thêm những ý tưởng trang trí độc đáo tại <strong>Nhà Lem</strong> để tạo nên những góc cảm hứng riêng nhé !</p>
</div>

  <!-- ================= CAM HUNG================= -->

<div class="inspiration-section">
  <h2 class="section-title">GÓC CẢM HỨNG</h2>

  <div class="inspiration-grid">

    <!-- Card 1 -->
    <a href="camhungphongkhach.php" class="product-card">
      <div class="image-wrapper">
        <img src="img/sofa/Ghe-sofa-AURORA.png" alt="Cảm hứng thu đông">
        
      </div>
      <div class="card-content">
        <h3>Cảm hứng phòng khách hiện đại & ấm cúng</h3>
        <p>Biến phòng khách thành nơi thư giãn lý tưởng với nội thất tinh tế, gam màu hài hòa và điểm nhấn đầy cảm hứng.</p>
      </div>
</a>
    ...
    <div class="inspiration-card">
      <div class="image-wrapper">
        <img src="img/camhung/camhungphongan.png" alt="Bình hoa">
        
      </div>
      <div class="card-content">
        <h3>Không gian phòng ăn tinh tế & đầy cảm xúc</h3>
        <p>Tận hưởng những bữa ăn trọn vẹn trong không gian ấm áp, nơi thiết kế và cảm xúc hòa quyện hoàn hảo.</p>
      </div>
    </div>
    ...
    <div class="inspiration-card">
      <div class="image-wrapper">
        <img src="img/camhung/khong-gian-song.png" alt="Trang trí Giáng sinh">
      </div>
      <div class="card-content">
        <h3>Không gian sống cân bằng & đầy cảm hứng</h3>
        <p>Tạo nên tổ ấm lý tưởng với sự kết hợp giữa thiên nhiên, ánh sáng và phong cách sống hiện đại.</p>
      </div>
    </div>
