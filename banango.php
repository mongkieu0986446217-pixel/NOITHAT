...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="121">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Ghe-Ban/Ban-an-go1.png">
        <img src="img/Ghe-Ban/Ban-an-go2.png">
        <img src="img/Ghe-Ban/Ban-an-go3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Ghe-Ban/Ban-an-go.png">
      </div>
    </div>
    ...
    <div class="product-info">
      ...
      <h1 id="product-name">Bàn ăn gỗ</h1>

      <div class="price">
        <span class="new-price">2.499.000đ</span>
        <span class="old-price">3.000.000đ</span>
  <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">2499000</span>
</div>


      <div class="description">

      <p><strong>Kích thước bàn:</strong> Dài 120 x Rộng 75 x Cao 75 cm</p>
      <p><strong>Chất liệu chính:</strong>Gỗ cao su và gỗ MFC/ MDF chuẩn CARB P2 (*)</p>
...
<section class="product-tabs">
    ...
    <div id="description" class="tab-body active">
        ...
        <div class="product-info">
            <div>
                <strong>Bàn ăn gỗ:</strong> đơn giản nhưng tinh tế, phong cách hiện đại với kích thước phù hợp với căn hộ nhỏ. Với màu gỗ Dark Grey Barn Wood hoặc Light Cabin Wood và mặt melamine xám Greige, bàn ăn này không chỉ đẹp mắt mà còn chắc chắn và dễ chịu khi sử dụng hàng ngày.
            </div>
            <div>
                <strong>Màu tự nhiên:</strong> Màu gỗ nhẹ của các căn nhà gỗ tại Narvik lấy cảm hứng từ những ngôi nhà trên núi với tầm nhìn tuyệt vời, đặc biệt vào ban đêm với ánh sáng Bắc Cực tuyệt đẹp. Màu gỗ nhẹ phản chiếu tuyệt vời ánh sáng trong nhà vào ban đêm hoặc ban ngày, mang đến cảm giác ấm cúng theo phong cách Bắc Âu. Màu xám đá núi cho các bộ đồ nệm phản chiếu ánh đèn vào ban đêm, tạo cảm giác hiện đại cho ngôi nhà theo phong cách Bắc Âu. Màu Greige tôn vinh tủ quần áo, phản chiếu ánh sáng tự nhiên và đèn vào ban đêm, tạo nên không gian hiện đại và thanh lịch.
            </div>
            
            <div>
                <strong>Màu sắc:</strong> Nâu gỗ tự nhiên
            </div>
            <div>
...
<script>
    // ================== CẤU HÌNH USER ==================
const isLoggedIn = "<?php echo isset($_SESSION['user_id']) && strpos($_SESSION['user_id'], 'guest_') === false ? 'true' : 'false'; ?>";

    function addToCart() {

    if (isLoggedIn !== "true") {
        alert("⚠️ Vui lòng đăng nhập để thêm vào giỏ hàng!");
        window.location.href = "trangchu.php"; // trang login
        return;
    }
