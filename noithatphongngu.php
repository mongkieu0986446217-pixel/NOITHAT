...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="noithatkhuvucS.css">
</head>
<body>
...
<section class="new-products">
 ...
 <div class="new-product-grid" id="livingRoomList">
  ...
  <a href="WNT/giuongngubocda.php" class="product-card">
...
<a href="WNT/tuquanaoVILINE1.php" class="product-card">
  ...
  <a href ="WNT/bantrangdiem.php" class="product-card">
      <img src="img/Ghe-Ban/Ban-trang-diem.png" alt="">
      <h3>Bàn trang điểm </h3>
      <p class="price">3.510.000đ</p>
    </a>
</div>
</section>
...
<script>
function loadphongnguProducts() {
  fetch("getSanPham.php?custom_order=33,35,36,48,53,54,75,76,34,40,65,67,48,133,70,71,19")
    .then(res => res.json())
    .then(data => {
      let html = "";
       ...
       data.forEach(sp => {
        ...
        if (sp.id == 33) {
          ...
          linkStart = `<a href="bantrangdiem.php" class="product-card">`;
          linkEnd = `</a>`;
        }
      ...
      document.getElementById("livingRoomList").innerHTML = html;
    });
}

window.onload = function() {
  loadphongnguProducts();
};
</script>
<script>
// ==================== USER ID CHUẨN ====================
