...
<section class="product-detail">
  ...
  <div class="product-container" id="product" data-id="33">

    <!-- LEFT -->
    <div class="product-gallery">
      <div class="thumbnail-list">
        <img src="img/Giuong/Giuong-ngu-go-tram1.png">
        <img src="img/Giuong/Giuong-ngu-go-tram2.png">
        <img src="img/Giuong/Giuong-ngu-go-tram3.png">
      </div>

      <div class="main-image">
        <img id="mainProductImage" src="img/Giuong/Giuong-go-tram.png">
      </div>
    </div>
...
<h1 id="product-name">Giường ngủ gỗ tràm</h1>

      <div class="price">
        <span class="new-price">13.000.000đ</span>
        <span class="old-price">13.999.000đ</span>
 <!-- GIÁ THẬT (dùng cho JS) -->
    <span id="product-price" style="display:none;">13000000</span>
</div>

      <div class="description">

      <p><strong>Kích thước bàn:</strong> Dài 212cm x Rộng 136/156/176/196cm x Cao đến đầu giường 92cm</p>
      <p><strong>Chất liệu:</strong></p>
      <p>Thân giường: Gỗ tràm tự nhiên, Veneer gỗ tràm tự nhiêns</p>
      <p>Chân giường: Gỗ cao su tự nhiên</p>
      <p>Tấm phản: Gỗ plywood chuẩn CARB-P2 (*)</p>
      <p class="note">
...
<section class="product-tabs">
    ...
    <div id="description" class="tab-body active">
        ...
        <div class="product-info">
            <div>
                <strong>Đặc điểm sản phẩm:</strong> Giường ngủ gỗ tràm kết hợp nét việt với nét đẹp hiện đại, dễ dàng phối hợp cùng các loại nội thất khác. 
            </div>
            <div>
                <strong>Thoải mái tựa lưng</strong> Cấu trúc đầu giường ngả về sau, theo chiều cơ thể
            </div>
            <div>
                <strong>Kết cấu vững chắc, chịu lực tốt</strong> Với thân gỗ cao su và thân gỗ tràm
            </div>
            <div>
                <strong>X3 khả năng chịu lực</strong> Với tấm phản Plywood, khung đỡ và thanh trụ sắt
            </div>
            <div>
                <strong>Không gian sống hoàn hảo</strong> Kiểu dáng hiên đại, thoáng hồn Việt mang đến không gian ấm cúng, và nhẹ nhàng cho phòng ngủ của bạn.
            </div>
            <div>
                <strong>Chi tiếc vật liệu:</strong> 
            </div>
            <div>
                <strong>Gỗ tràm tự nhiên</strong> Sử dụng gỗ tràm tự nhiên đảm bảo vệ độ chắc chắn cao, chống công vênh, mối mọt cho giường ngủ của bạn.
            </div>
            <div>
                <strong>Gỗ thông</strong> Sử dụng chất liệu gỗ thông giúp giường ngủ VLINE 601 có khả năng chịu lực tốt và độ bền cao. 
            </div>
            <div>
    ...
    <div id="reviews" class="tab-body">
        ...
        <div class="review-item">
            ...
            <p>Đúng mô tả, sẽ ủng hộ lần sau.</p>
        </div>
...
<script>
fetch("getSanPham.php?custom_order=39,38,37,36,43,36,40,45,34")
  .then(res => res.json())
  .then(data => {
